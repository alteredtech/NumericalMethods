...
def ADI(k=0.835,tempLeft=75,tempRight=50,tempTop=100,tempBottom=0,tempPlate=0,x_node=40,y_node=40,delta=10,finalTime=300,timeStep=10):
    new_x = int((x_node+1)/delta)+1
    new_y = int((y_node+1)/delta)+1
